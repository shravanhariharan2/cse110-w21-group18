...
export default class TaskListController {
  constructor() {
    ...
    this.deleteCompletedList = this.deleteCompletedList.bind(this);
    ...
    this.DOM_ELEMENTS = {
      ...
      deleteCompletedList: document.getElementById('delete-completed-list'),
    ...
    this.DOM_ELEMENTS.deleteCompletedList.addEventListener('click', this.deleteCompletedList.bind(this));
  }
  ...
  showSelectedTask() {
    ...
    this.DOM_ELEMENTS.deleteCompletedList.style.display = 'none';
  ...
  /**
   * Hides the Completed task list (and delete all button) if there are no completed tasks
   */
    ...
    if (this.DOM_ELEMENTS.addTaskButton.style.display !== 'none') {
      ...
      if (hasCompletedTasks) {
        ...
        if (this.completedIsExpanded) {
          this.DOM_ELEMENTS.deleteCompletedList.style.display = 'inline';
        }
      } else {
        this.DOM_ELEMENTS.completedListTitle.style.display = 'none';
        this.DOM_ELEMENTS.deleteCompletedList.style.display = 'none';

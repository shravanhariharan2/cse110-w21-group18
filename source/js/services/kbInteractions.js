  ...
  */
  onKeyUp(event) {
    ...
    if (document.activeElement === this.DOM_ELEMENTS.inputTextField
      || document.activeElement === this.DOM_ELEMENTS.notesTextField) this.kbMutex = true;
    ...
    handleEnter(event, mutex) {
      ...
      if (this.focusIdx === 0) {
        ...
        || this.DOM_ELEMENTS.inputBox.style.display === undefined) {
          ...
          if (this.DOM_ELEMENTS.inputTextField.value.length === 0) this.DOM_ELEMENTS.cancelInput.click();
          else this.DOM_ELEMENTS.acceptInput.click();
        }
      }
    ...
    */
    incrementIdx() {
      ...
      if (this.DOM_ELEMENTS.taskList.children.length > 0) this.focusIdx = ((this.focusIdx + 1) % (this.DOM_ELEMENTS.taskList.children.length + 1));
      else this.focusIdx = 0;
    }

...
class TaskList {
  constructor() {
    ...
    this.DOM_ELEMENTS.collapseTaskList.addEventListener('click', this.collapseTaskList);
    this.DOM_ELEMENTS.expandTaskList.addEventListener('click', this.expandTaskList);
